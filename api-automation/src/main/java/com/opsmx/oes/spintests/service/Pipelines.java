...
public class Pipelines extends BaseClass {
    ...
    public static synchronized Response createPipeline(final String type, final String appName, final String pipelineName)
        ...
        try {
            ...
            } else if(type == Constants.DOCKER) {
                payload = new DockerDeployPipelineBuilder().buildPipeline(appName, pipelineName).toJson();
            } else if(type == Constants.DOCKER_TRIGGER_DEPLOYMENT) {
                payload = new DockerTriggerDeployPipelineBuilder().buildPipeline(appName, pipelineName).toJson();
     ...
     * @return response
     */
    public static Response executePipeline(final String appName, final String sleepTime) {
        try {
            ...
            String dockerDeploymentPipeline = config.getConfigData("dockerDeploymentPipelineName");
            ...
            pipelinesList.add(dockerDeploymentPipeline);
    ...
    public static Response updatePipeline(final String appName, final String originalPipelineName,
                                          final String updatedPipelineName, final String sleepTime) {
        try {
